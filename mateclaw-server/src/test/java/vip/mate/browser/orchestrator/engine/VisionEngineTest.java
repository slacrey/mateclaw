...
class VisionEngineTest {
    ...
    void setUp() {
        ...
        engine = new VisionEngine(screenshotClient, chatModelFactory, retryTemplate, mapper, modelResolver);
     ...
     * {@link ChatClient} chain to return {@code content} when called. We
     * intercept at the {@link ChatModel#call(org.springframework.ai.chat.prompt.Prompt)}
     * boundary since {@link ChatClient#create} delegates to it; that lets us
     * keep this fixture free of Spring AI mock-builder gymnastics.
     */
