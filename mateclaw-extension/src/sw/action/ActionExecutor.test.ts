...
describe('ActionExecutor', () => {
  ...
  it('routes type / scroll / scroll_region / move_mouse / wait to their handlers', async () => {
    ...
    const exec = new ActionExecutor({ type, scroll, scroll_region, move_mouse, wait } as unknown as ActionHandlers)
